...
ENT.PrintName = "Balancing Beam (Medium)"
ENT.Author = ""
...
function ENT:BalanceLengthExact(length)
	...
	local mins, maxs = Vector(-16, -5, -0), Vector(6, 6, length)
...
function ENT:Initialize()
	...
	local mins, maxs = Vector(-5, -5, -0), Vector(6, 6, height)
